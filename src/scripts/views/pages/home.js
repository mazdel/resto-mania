...
const Home = {
  async render() {
    ...
    <section id='hero'>
      <div class='hero'>
        <picture>
          <source media="(min-width: 768px)" data-srcset="/images/alt_heroes/hero-image_4.jpg">
          <source media="(min-width: 480px)" data-srcset="/images/alt_heroes/hero-image_4-medium.jpg">
          <img alt="hero image" src="/images/alt_heroes/hero-image_4-lqip.jpg" class="lazyload" data-src='/images/alt_heroes/hero-image_4-small.jpg'>
        </picture>
      </div>
    </section>
